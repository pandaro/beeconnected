...
$options2 = array(
	...
	"date" => array($date,'date',	'rgba(0,0,0,1)','rgba(250,250,250,0.0)'),			
	"voltage" => array($volt,'volt','rgba(0,0,250,1)','rgba(0,250,250,0.0)'),
	
	"temperature" => array($temperature,	'temperature','rgba(250,50,0,1)','rgba(250,250,250,0.0)'),	
	"brightness" => array($brightness,	'brightness','rgba(250,250,0,1)','rgba(250,250,250,0.0)'),	
	"humidity" => array($humidity,	'humidity','rgba(0,250,0,1)','rgba(250,250,250,0.0)'),		
	"pressure" => array($pressure,	'pressure','rgba(250,100,0,1)','rgba(250,250,250,0.0)'),		
	"total_weight" => array($total_weight,	'total weight','rgba(0,0,50,1)','rgba(250,250,250,0.0)'),
	"middleweight" => array($middleweight,'	middleweight','rgba(0,50,0,1)','rgba(250,250,250,0.0)'),
	//SCALES
